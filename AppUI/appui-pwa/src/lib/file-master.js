...
class FileMaster {
   ...
   */
  getFileContent () {
    if (isEmpty(this.file.handle)) return;
    logger('this.file.content', this.file.content);
  ...
  /**
   * 設定中の FileSystemFileHandle (Device File) からコンテンツを取得します
   */
